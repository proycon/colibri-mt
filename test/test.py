...
class TestExperiment(unittest.TestCase):
    def setUp(self):
        ...
        self.r = os.system("./exp-test.sh")

    def test000_experiment(self):
    ...
    def test002_sourcedump(self):
        ...
        r = os.system("diff test-en-nl/test-en-train.phrasetable.sourcedump test-en-nl/test-en-train.phrasetable.sourcedump.ok")
        self.assertEqual(r,0)

    def test003_targetdump(self):
        """Verifying target dump"""
        r = os.system("diff test-en-nl/test-nl-train.phrasetable.targetdump test-en-nl/test-nl-train.phrasetable.targetdump.ok")
        self.assertEqual(r,0)
